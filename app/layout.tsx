...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en"><body className="font-body text-gray-900">
      <div className="ribbon text-center text-sm py-1">Established since 1999</div>
      <Suspense fallback={<div className="h-[var(--header-height)]" />}><LangProvider><Header/></LangProvider></Suspense>
      <LangProvider><main className="min-h-[60vh]">{children}</main><Footer/></LangProvider>
    </body></html>
  );
}
